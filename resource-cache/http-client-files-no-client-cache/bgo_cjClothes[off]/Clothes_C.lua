...
local theMarkers = {
    {1510.451171875,-1823.7231445313,13.546875, 0, 0}, -- Grove street
	--[[
            ...
            if ( getElementModel ( localPlayer ) == 0 ) then
                ...
                if (z2 > maxZ) then return end
                    ...
                    setTimer( function ()       
                        ...
                        --else
                            setElementPosition( localPlayer,  2372.58203125,-1124.4793701172,1050.875 )

                        --end
                        
                        setElementFrozen( localPlayer, true )
                        
						setElementInterior( localPlayer, 8 )
                        setElementDimension( localPlayer, math.random( 10,6543 ) )
                        setCameraMatrix( 2372.4895019531,-1128.5679931641,1050.8825683594, 2372.58203125,-1124.4793701172,1050.875, 0, 70 )
                        setTimer( function ()
						setElementRotation( localPlayer, 0, 0, 180.33865356445 )
						end, 1000, 2 )
                        setTimer( function ()
                ...
                exports.bgo_hud:dm( "Você precisa da skin do CJ antes de poder definir a roupa", 225, 0, 0 )
            end
        end
    end
end
...
function ()             
    ...
    setTimer( function ()
        ...
        --else
            setElementPosition( localPlayer, 1513.0541992188,-1820.6754150391,13.546875 )
...
function () 
    ...
    if ( getElementData(localPlayer,"char:money") >= tonumber( recountTotalPrice () ) ) then
        fadeCamera( false, 1.0, 0, 0, 0 )
        setTimer( fadeCamera, 2000, 1, true, 1.0, 0, 0, 0 )
