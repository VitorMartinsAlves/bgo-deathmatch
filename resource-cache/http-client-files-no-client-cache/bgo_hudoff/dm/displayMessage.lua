...
local aX,aY,aW,aH = sX*(1360), (sY*1412), sX*0.75, sY*0.95
--if (sX <= 1280) then
--	aX,aY,aW,aH = (sX/2)-(1280/4), (sY*0.75)-20, (sX/2)+(1280/4), sY*0.95
---end
	...
	for i,v in ipairs(DXMessages) do
		if (v[5] > getTickCount()) then
			--dxDrawRectangle(aX, aY-( (i-1) *20), aW-aX, aH-aY, tocolor(0, 0, 0, 200))
					dxDrawText(v[1], aX+1, aY-( (i-1) *20)+1, aW, aH-( (i-1) *20), tocolor(0, 0, 0, 255), 1.5, font, "center", "center", false, false, false, true)
			dxDrawText(v[1], aX, aY-( (i-1) *20), aW, aH-( (i-1) *20), tocolor(v[2], v[3], v[4], 255), 1.5, font, "center", "center", false, false, false, true)
