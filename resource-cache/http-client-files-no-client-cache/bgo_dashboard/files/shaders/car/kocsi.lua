...
function startCarPaintReflect()
		...
		local v = Settings2.var
		-- Create stuff
		grunShader = dxCreateShader ( "files/shaders/car/fx/car_refgrun.fx",1,v.renderDistance,false)
		geneShader = dxCreateShader ( "files/shaders/car/fx/car_refgene.fx",1,v.renderDistance,true)
		shatShader = dxCreateShader ( "files/shaders/car/fx/car_refgene.fx",1,v.renderDistance,true)
		...
		if grunShader and geneShader and shatShader and myScreenSourceKocsi then
			...
			-- Set texture
			textureVol = dxCreateTexture ( "files/shaders/car/images/smallnoise3d.dds" )
