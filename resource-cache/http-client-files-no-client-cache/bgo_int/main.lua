...
objects.replace = {
	...
	{5418, "lae711block01"},
	--{17700, "pigpenblok1_lae2"},   -- MAPA DO OSCRIA
...
function mapas()
	...
	setElementFrozen(localPlayer, true)
		...
		setTimer(
			...
			txd = engineLoadTXD ("pigpenblok1_lae2.txd")
			engineImportTXD (txd, 17700)
			dff = engineLoadDFF ("files/pigpenblok1_lae2.dff")
			engineReplaceModel (dff, 17700)
			col_floors = engineLoadCOL ("files/cols/pigpenblok1_lae2.col")
			engineReplaceCOL (col_floors, 17700 )



			txdbank2 = engineLoadTXD ("atuais/bank2.txd")
			engineImportTXD (txdbank2, 4600)
			dffbank2 = engineLoadDFF ("atuais/bank2.dff")
			engineReplaceModel (dffbank2, 4600)
			colbank2 = engineLoadCOL ("atuais/bank2.col")
			engineReplaceCOL (colbank2, 4600 )
			
			txdKUT = engineLoadTXD ("atuais/KUT.txd")
			engineImportTXD (txdKUT, 3465)
			dffKUT = engineLoadDFF ("atuais/KUT.dff")
			engineReplaceModel (dffKUT, 3465)
			colKUT = engineLoadCOL ("atuais/KUT.col")
			engineReplaceCOL (colKUT, 3465 )		
...
removeWorldModel(5681,10000,0,0,0) -- BANCO
removeWorldModel(1676,10000,0,0,0)  -- BANCO