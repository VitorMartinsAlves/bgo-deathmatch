...
addEventHandler("onClientRender", root, function()
	if pickerData and pickerData["colortype"] ~= nil and pickerData["active"] then
		...
		dxDrawText("BGO MTA - #7cc576SCores", pickerData["posX"]+5, pickerData["posY"]-25+22/2, pickerData["width"], pickerData["posY"]-25+22/2, tocolor(255, 255, 255, 255), 1 , "default-bold", "left", "center", false, false, false, true)
