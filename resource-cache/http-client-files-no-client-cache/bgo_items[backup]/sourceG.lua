...
itemLists = {
	...
	{name = "M16 Plublack", desc="Deixará de ser VIP no dia 03/04/2020..", weight=3.5, stack = false, weaponID = 31, AmmoID = 59, level=3, itemTypes= 'weapon'}, --126
	...
	{name = "Aliança de Casamento Johnny & Elias", desc="Companheiros e Amigos para sempre!", weight=0.1, stack = true, weaponID = false, AmmoID = false, level=0, itemTypes= 'bag'}, --279
	...
	{name = "M4 - Natalina", desc="EDIÇÃO NATAL 2019", weight=2.2, stack = false, weaponID = 31, AmmoID = 57, level=3, itemTypes= 'weapon'}, --303
	{name = "AK-47 - Natalina", desc="EDIÇÃO NATAL 2019", weight=2.2, stack = false, weaponID = 30, AmmoID = 57, level=3, itemTypes= 'weapon'}, --304
	{name = "Sniper - Natalina", desc="EDIÇÃO NATAL 2019", weight=2.2, stack = false, weaponID = 34, AmmoID = 57, level=3, itemTypes= 'weapon'}, --305
	{name = "Desert - Natalina", desc="EDIÇÃO NATAL 2019", weight=2.2, stack = false, weaponID = 24, AmmoID = 57, level=3, itemTypes= 'weapon'}, --306
