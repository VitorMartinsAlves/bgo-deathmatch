...
addEventHandler("onClientElementStreamIn", root, function()
	...
	for i,vehicle in ipairs(getElementsByType("vehicle", resourceRoot, true)) do
		if (getElementData(vehicle, "rentalVIP")) then
			setElementCollidableWith(source, vehicle, false)
		end
	end
end)
...
addEvent("GTIrentals.removeGhostmode2", true)
addEventHandler("GTIrentals.removeGhostmode2", root, function()
	for i,vehicle in ipairs(getElementsByType("vehicle")) do
		if (not getElementData(vehicle, "rentalVIP")) then
...
addEvent("GTIrentals.destroyRental2", true)
addEventHandler("GTIrentals.destroyRental2", root, function()
	local car = source
