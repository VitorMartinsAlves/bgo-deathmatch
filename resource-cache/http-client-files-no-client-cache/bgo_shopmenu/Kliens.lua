...
return 
	...
	triggerServerEvent("Pizza2",localPlayer, valor)
	elseif (command == "Suco") then
	triggerServerEvent("Suco",localPlayer, valor)
	elseif (command == "Hamburguer") then
	triggerServerEvent("Hamburguer",localPlayer, valor)
	elseif (command == "Taco") then
	triggerServerEvent("Taco",localPlayer, valor)
	elseif (command == "Celular") then
	triggerServerEvent("Celular",localPlayer, valor)
	elseif (command == "Energetico") then
	triggerServerEvent("Energetico",localPlayer, valor)
	elseif (command == "Radinho") then
	triggerServerEvent("Radinho",localPlayer, valor)
	elseif (command == "Mochila") then
	triggerServerEvent("Mochila",localPlayer, valor)
	end
	end
end
addEvent("ComprarLoja", true)
addEventHandler("ComprarLoja", root, ComprarLoja)
