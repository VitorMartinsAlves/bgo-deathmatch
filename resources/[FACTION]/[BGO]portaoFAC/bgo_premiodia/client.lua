...
function renderFunction()
	...
	for day,t in pairs(prizes) do
		...
		-- texts
		dxDrawText(day.."",posX,posY,posX+mw,posY+ih/5,color,nil,"default-bold","center","center",nil,nil,true)
		dxDrawText((t[2]+t[2]*(weekCount/2))..t[3]..iif(day==current,"\nCLIQUE PARA OBTER",""),posX,posY+4*mh/5,posX+mw,posY+mh,color,nil,"default-bold","center","center",nil,nil,true)
		-- img
