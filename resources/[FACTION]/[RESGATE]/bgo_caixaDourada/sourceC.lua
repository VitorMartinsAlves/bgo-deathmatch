...
addEvent('btcMTA->destroyEventDourada', true)
addEventHandler('btcMTA->destroyEventDourada', root, function()
		...
		if isMouseInPosition(panelX+225,panelY+150,210,40) then
			...
			timer1 = setTimer(function()
				...
				-- if(data[1]==2 or data[1]==4)then
					...
					triggerServerEvent("btcMTA->#giveItemDourada",localPlayer,localPlayer,data[2],objects, data[3])
...
addEvent('btcMTA->iniciarEventDourada', true)
addEventHandler('btcMTA->iniciarEventDourada', root, startEventFunction)
