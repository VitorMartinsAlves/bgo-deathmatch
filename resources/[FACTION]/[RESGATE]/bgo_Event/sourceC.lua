...
function createEventPanel()
	local added = (sx - minRand*imgO) / 2
		...
		dxDrawImage(x,y,panelW-400,panelH-50, "files/case.png", 0, 0, 0, tocolor(255,255,255,255))
...
addEventHandler('onClientClick', root, function (button, state, _, _, _, _, _, element)
 ...
 triggerServerEvent("btcMTA->#setPlayerMe", localPlayer, localPlayer, "Ganhou um item na caixa: (" .. text .. ")")
