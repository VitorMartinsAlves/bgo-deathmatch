...
addEvent('btcMTA->destroyEventRara', true)
addEventHandler('btcMTA->destroyEventRara', root, function()
		...
		if isMouseInPosition(panelX+225,panelY+150,210,40) then
			...
			timer1 = setTimer(function()
				...
				-- if(data[1]==2 or data[1]==4)then
					...
					triggerServerEvent("btcMTA->#giveItem2",localPlayer,localPlayer,data[2],objects, data[3])
...
addEvent('btcMTA->iniciarEventRara', true)
addEventHandler('btcMTA->iniciarEventRara', root, startEventFunction)
