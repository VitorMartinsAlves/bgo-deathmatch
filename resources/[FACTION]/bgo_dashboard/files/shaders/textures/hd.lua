...
function enableDetail()
	...
	-- Load textures
	detail22Texture = dxCreateTexture('files/shaders/textures/detail22.png', "dxt3")
	detail58Texture = dxCreateTexture('files/shaders/textures/detail58.png', "dxt3")
	detail68Texture = dxCreateTexture('files/shaders/textures/detail68.png', "dxt1")
	detail63Texture = dxCreateTexture('files/shaders/textures/detail63.png', "dxt3")
	dirtyTexture = dxCreateTexture('files/shaders/textures/dirty.png', "dxt3")
	detail04Texture = dxCreateTexture('files/shaders/textures/detail04.png', "dxt3")
	detail29Texture = dxCreateTexture('files/shaders/textures/detail29.png', "dxt3")
	detail55Texture = dxCreateTexture('files/shaders/textures/detail55.png', "dxt3")
	detail35TTexture = dxCreateTexture('files/shaders/textures/detail35T.png', "dxt3")
...
function getMakeShader(v)
	...
	local shader,tec = dxCreateShader ( "files/shaders/textures/detail.fx", 1, 100 )
	if shader then
