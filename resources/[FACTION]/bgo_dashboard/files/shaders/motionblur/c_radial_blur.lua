...
function enableRadialBlur()
    ...
    radialMaskTexture = dxCreateTexture( "files/shaders/motionblur/images/radial_mask.tga", "dxt5" )
    radialBlurShader,tecName = dxCreateShader( "files/shaders/motionblur/fx/radial_blur.fx" )
