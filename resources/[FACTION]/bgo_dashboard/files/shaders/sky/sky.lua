...
function startShaderResource()
 ...
 skydome_shader = dxCreateShader ( "files/shaders/sky/shaders/shader_skydome.fx",0,0,true,"object" )
 null_shader = dxCreateShader ( "files/shaders/sky/shaders/shader_null.fx" )
 skydome_texture=dxCreateTexture("files/shaders/sky/textures/skydome.jpg")
 ...
 txd_skybox = engineLoadTXD('files/shaders/sky/models/skybox_model.txd')
 engineImportTXD(txd_skybox, modelID)
 dff_skybox = engineLoadDFF('files/shaders/sky/models/skybox_model.dff', modelID)
