...
function enableContrast(a)
	if a == true then
		...
		blurHShader,tecName = dxCreateShader( "files/shaders/contrast/blurH.fx" )
	--	outputDebugString( "blurHShader is using technique " .. tostring(tecName) )

		blurVShader,tecName = dxCreateShader( "files/shaders/contrast/blurV.fx" )
	--	outputDebugString( "blurVShader is using technique " .. tostring(tecName) )

		brightPassShader,tecName = dxCreateShader( "files/shaders/contrast/brightPass.fx" )
	--	outputDebugString( "brightPassShader is using technique " .. tostring(tecName) )

		addBlendShader,tecName = dxCreateShader( "files/shaders/contrast/addBlend.fx" )
