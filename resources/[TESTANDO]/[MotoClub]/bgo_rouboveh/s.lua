...
function repairCar(part, vehicle, cost)
	...
	--triggerEvent("vehicleLock",source, vehicle, false)
	--[[
...
addEvent("assaltoveiculo", true)
addEventHandler("assaltoveiculo", getRootElement(), repairCar)
...
addEvent("assaltoveiculo2", true)
addEventHandler("assaltoveiculo2", getRootElement(), repairCar2)
