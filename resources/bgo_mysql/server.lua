...
local sqlDatas = {
	["host"] = "177.153.39.59",
	["user"] = "u24_DtZfK3lStX",
	["pw"] = "87s6SJ32J0qg@g=TgHTNV9lK",
	["database"] = "brasilmatamata_btc",
}
]]--
...
addEventHandler("onResourceStart", resourceRoot, function()
	...
	--dbHandler = dbConnect("mysql","dbname=".. sqlDatas["database"] ..";host="..sqlDatas["host"]..";port=13306", sqlDatas["user"], sqlDatas["pw"], "autoreconnect=1")

	dbHandler = dbConnect("mysql","dbname=".. sqlDatas["database"] ..";host="..sqlDatas["host"]..";port=13306", sqlDatas["user"], sqlDatas["pw"], "charset=utf8")


	if not dbHandler then
		outputDebugString("[mysql]: Banco de dados n?o conectado")
		cancelEvent(true)
	else
	outputDebugString("[mysql]: Banco de dados conectado RIO!")
	end
end)
