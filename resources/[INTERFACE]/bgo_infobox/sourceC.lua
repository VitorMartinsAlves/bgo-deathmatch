	...
	function()
		for k, v in pairs(notificationData) do
			...
			elseif (v.Type == 'warning') then
				dxDrawImage(v.CurrentX + 5, 22, 26, 26,"files/w.png",0,0,0,tocolor(255,255,255,v.Alpha),true)
			elseif (v.Type == 'info') then
				dxDrawImage(v.CurrentX + 5, 22, 26, 26,"files/i.png",0,0,0,tocolor(255,255,255,v.Alpha),true)
