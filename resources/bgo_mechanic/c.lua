								...
								if hasPartGotProblem(v, k) then
									...
									if cx then
										if isInBoxEdited(cx, cy, scx-(30*scmp), scy-(10*scmp), (120*scmp), (dxGetFontHeight(1.2*scmp, "arial")+(40*scmp))) and overPart == k then
											dxDrawRectangle(scx-(30*scmp), scy-(10*scmp), dxGetTextWidth(getNameFromPart(k), 1.2*scmp, "arial")+(40*scmp), (dxGetFontHeight(1.2*scmp, "arial")+(20*scmp)), tocolor(255,255,255, 230))
											dxDrawText(getNameFromPart(k), scx, scy, scx+dxGetTextWidth(getNameFromPart(k), 1.2*scmp, "arial"), scy+(50*scmp), tocolor(0,0,0), 1.2*scmp, "arial", "center")
										else
											dxDrawRectangle(scx-(30*scmp), scy-(10*scmp), dxGetTextWidth(getNameFromPart(k), 1.2*scmp, "arial")+(40*scmp), (dxGetFontHeight(1.2*scmp, "arial")+(20*scmp)), tocolor(255,255,255, 160))
											dxDrawText(getNameFromPart(k), scx, scy, scx+dxGetTextWidth(getNameFromPart(k), 1.2*scmp, "arial"), scy+(50*scmp), tocolor(0,0,0), 1.2*scmp, "arial", "center")
										end
									else
										dxDrawRectangle(scx-(30*scmp), scy-(10*scmp), dxGetTextWidth(getNameFromPart(k), 1.2*scmp, "arial")+(40*scmp), (dxGetFontHeight(1.2*scmp, "arial")+(20*scmp)), tocolor(255,255,255, 160))
							...
							if cx then
								if isInBoxEdited(cx, cy, engx-(30*scmp), engy-(10*scmp), dxGetTextWidth("Motor", 1.2*scmp, "arial")+(40*scmp), (dxGetFontHeight(1.2*scmp, "arial")+(20*scmp))) then
									...
									if overPart == "Motor" then
										dxDrawRectangle(engx-(30*scmp), engy-(10*scmp), dxGetTextWidth("Motor", 1.2*scmp, "arial")+(40*scmp), (dxGetFontHeight(1.2*scmp, "arial")+(20*scmp)), tocolor(255,255,255, 230))
										dxDrawText("Motor", engx, engy, engx+dxGetTextWidth("Motor", 1.2*scmp, "arial"), engy+(50*scmp), tocolor(0,0,0), 1.2*scmp, "arial", "center")
									else
										dxDrawRectangle(engx-(30*scmp), engy-(10*scmp), dxGetTextWidth("Motor", 1.2*scmp, "arial")+(40*scmp), (dxGetFontHeight(1.2*scmp, "arial")+(20*scmp)), tocolor(255,255,255, 160))
										dxDrawText("Motor", engx, engy, engx+dxGetTextWidth("Motor", 1.2*scmp, "arial"), engy+(50*scmp), tocolor(0,0,0), 1.2*scmp, "arial", "center")
									end
								else
									dxDrawRectangle(engx-(30*scmp), engy-(10*scmp), dxGetTextWidth("Motor", 1.2*scmp, "arial")+(40*scmp), (dxGetFontHeight(1.2*scmp, "arial")+(20*scmp)), tocolor(255,255,255, 160))
...
addEventHandler("onClientVehicleEnter", getRootElement(),
    function(thePlayer, seat)
		...
		if getElementData(source, "repairingAlready") == true then
           setElementData(source, "repairingAlready", false)
		   end
        end
    end
)
