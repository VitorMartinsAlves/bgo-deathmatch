...
addEventHandler("onClientResourceStart", resourceRoot,
    function ( startedRes )
    customIfp = engineLoadIFP ("Fortnite_pt1.ifp", "Fortnite_1")
    customIfp2 = engineLoadIFP ("Fortnite_pt2.ifp", "Fortnite_2")
    customIfp3 = engineLoadIFP ("Fortnite_pt3.ifp", "Fortnite_3")
