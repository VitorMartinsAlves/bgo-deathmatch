...
addEventHandler("onResourceStart", resourceRoot, function()
	...
	dbHandler = dbConnect("mysql","dbname=".. sqlDatas["database"] ..";host="..sqlDatas["host"]..";port=13306", sqlDatas["user"], sqlDatas["pw"], "share=0")
	...
	outputDebugString("[mysql]: Banco de dados conectado!")
	end
end)
