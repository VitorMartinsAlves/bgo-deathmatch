...
creation.window[1] = guiCreateWindow(sX, sY, wX, wY, "Brasil Gaming Online - Criação", false)
guiWindowSetSizable(creation.window[1], false)
guiSetAlpha(creation.window[1], 0.90)
guiSetVisible(creation.window[1], false)
-- Labels
creation.label[1] = guiCreateLabel(11, 27, 130, 15, "Endereço:", false, creation.window[1])
...
creation.label[3] = guiCreateLabel(11, 146, 99, 15, "Preço:", false, creation.window[1])
...
creation.label[5] = guiCreateLabel(9, 230, 211, 24, "Pressione X para tirar o cursor do mouse para poder andar.", false, creation.window[1])
...
creation.button[2] = guiCreateButton(14, 197, 207, 27, "Criar casa!", false, creation.window[1])
