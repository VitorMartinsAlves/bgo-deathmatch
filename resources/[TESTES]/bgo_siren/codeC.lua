...
local Cars = {  [490]=true, [416]=true, [585]=true, [596]=true, [409]=true, [597]=true, [598]=true, [427]=true, [426]=true, [523]=true, [546]=true, [445]=true, [479]=true }
...
function showSirenPanel()
	...
	dxDrawText("BGOMTA- Sirene",x+panelSize[1]/2-1, y+20/2+1, x+panelSize[1]/2-60-1, y+20/2+1, tocolor(0, 0, 0, 255),1, Font, "center", "center", false, false, false, true) 
	dxDrawText("#3D7ABCBGO#ffffffMTA- #ffffffSirene",x+panelSize[1]/2, y+20/2, x+panelSize[1]/2-60, y+20/2, tocolor(255, 255, 255, 255),1, Font, "center", "center", false, false, false, true) 
	for index, value in ipairs (sirenTable) do 
		...
		if getElementType ( source ) == "vehicle" and dataName == "vehicle:siren" then
			...
			if (isElementStreamedIn (source)) then
				if newStation ~= 0 then
					...
					setSoundVolume(newSoundElement, 0.2)
					soundElementsOutside[source] = newSoundElement
					setElementDimension(newSoundElement, getElementDimension(source))
					setElementDimension(newSoundElement, getElementDimension(source))
					setSoundMinDistance(soundElementsOutside[source], 1)
					setSoundMaxDistance(soundElementsOutside[source], 100)
...
function toggleFlashers()
	...
	if (theVehicle) and getPedOccupiedVehicleSeat(localPlayer) < 2  then
		...
		if getElementModel(theVehicle) == 490 or getElementModel(theVehicle) == 409 or getElementModel(theVehicle) == 408 or getElementModel(theVehicle) == 585 or getElementModel(theVehicle) == 550 or getElementModel(theVehicle) == 445 or getElementModel(theVehicle) == 574 or getElementModel(theVehicle) == 525 or getElementModel(theVehicle) == 443 or getElementModel(theVehicle) == 418 or getElementModel(theVehicle) == 546 or getElementModel(theVehicle) == 547 or getElementModel(theVehicle) == 598 or getElementModel(theVehicle) == 597 or getElementModel(theVehicle) == 596 or getElementModel(theVehicle) == 416 or getElementModel(theVehicle) == 427 or getElementModel(theVehicle) == 426 or getElementModel(theVehicle) == 586  then
