...
row = 5 -- // Sor
column = 10 -- // Oszlop
baseWeight = 30 --// Alap peso
oneLevelBag = 40 -- // Sima táska
premiumLevelBag = 55 -- // Sima táska
...
itemLists = {
	...
	{name = "Chave do veículo", desc="A chave do seu veículo.", weight=0.01, stack = false, weaponID = false, AmmoID = false, level=0, itemTypes= 'key'}, --17
	...
	{name = "Pendrive HACKER", desc="Coletar informações", weight=0.1, stack = false, weaponID = false, AmmoID = false, level=0, itemTypes= 'bag'}, --23
	...
	{name = "Baseball", desc="Uma ferramenta popular para esportes de beisebol.", weight=2, stack = false, weaponID = 5, AmmoID = false, level=2, itemTypes= 'weapon'}, --39
	...
	{name = "Desert Eagle", desc="Uma arma com risco de vida contendo munição forte.", weight=6, stack = false, weaponID = 24, AmmoID = 57, level=3, itemTypes= 'weapon'}, --44
	{name = "Arna de choque", desc="É uma arma popular de aplicação da lei.", weight=0.5, stack = false, weaponID = 23, AmmoID = false, level=0, itemTypes= 'weapon'}, --45
	{name = "Colt-45", desc="O menor pedaço de pistola.", weight=1.5, stack = false, weaponID = 22, AmmoID = 57, level=3, itemTypes= 'weapon'}, --46
	{name = "Espingarda shotgun espingarda", desc="Arma grande calibre que é muito perigoso.", weight=10, stack = false, weaponID = 26, AmmoID = 60, level=3, itemTypes= 'weapon'}, --47
	{name = "Combat shotgun", desc="Arma popular do terrorista.", weight=10, stack = false, weaponID = 27, AmmoID = 60, level=3, itemTypes= 'weapon'}, --48
	{name = "Micro Uzi", desc="A arma popular dos julgamentos.", weight=6, stack = false, weaponID = 28, AmmoID = 61, level=3, itemTypes= 'weapon'}, --49
	{name = "MP5", desc="Arma popular do terrorista.", weight=6, stack = false, weaponID = 29, AmmoID = 61, level=3, itemTypes= 'weapon'}, --50
	{name = "AK-47", desc="Arma grande calibre que é perigoso.", weight=13, stack = false, weaponID = 30, AmmoID = 58, level=3, itemTypes= 'weapon'}, --51
	{name = "M16", desc="Arma grande calibre que é perigoso.", weight=13, stack = false, weaponID = 31, AmmoID = 59, level=3, itemTypes= 'weapon'}, --52
	{name = "Tec-9", desc="A arma popular dos julgamentos.", weight=6, stack = false, weaponID = 32, AmmoID = 61, level=3, itemTypes= 'weapon'}, --53
	...
	{name = "Magnum Sniper", desc="Uma segmentação e baaammm.", weight=15, stack = false, weaponID = 34, AmmoID = 69, level=3, itemTypes= 'weapon'}, --68
	...
	{name = "Rifle M40A1", desc="Arma popular dos caçadores.", weight=14, stack = false, weaponID = 33, AmmoID = 69, level=3, itemTypes= 'weapon'}, --103
	...
	{name = "MP5 Royal", desc="Adesivo de arma..", weight=6, stack = false, weaponID = 29, AmmoID = 61, level=3, itemTypes= 'weapon'}, --116
	{name = "MP5 Hyper Beast", desc="Adesivo de arma..", weight=6, stack = false, weaponID = 29, AmmoID = 61, level=3, itemTypes= 'weapon'}, --117
	{name = "MP5 Fade", desc="Adesivo de arma..", weight=6, stack = false, weaponID = 29, AmmoID = 61, level=3, itemTypes= 'weapon'}, --118
	{name = "Pinky Desert Eagle", desc="O PODER ROSA!", weight=6, stack = false, weaponID = 24, AmmoID = 57, level=3, itemTypes= 'weapon'}, --199
	{name = "M16 BOOM", desc="SHOW, SHOW! A MELHOR!", weight=12, stack = false, weaponID = 31, AmmoID = 59, level=3, itemTypes= 'weapon'}, --120
	--{name = "Iphone 7", desc="O meio mais imp", weight=0.3, stack = false, weaponID = false, AmmoID = false, level=0, itemTypes= 'bag'}, --16


	{name = "Red Shade Uzi", desc="Adesivo de arma..", weight=6, stack = false, weaponID = 28, AmmoID = 61, level=3, itemTypes= 'weapon'}, --121
	{name = "MP5 Cobalt", desc="Adesivo de arma..", weight=6, stack = false, weaponID = 29, AmmoID = 61, level=3, itemTypes= 'weapon'}, --122
	{name = "Gold Uzi", desc="Adesivo de arma..", weight=6, stack = false, weaponID = 28, AmmoID = 61, level=3, itemTypes= 'weapon'}, --123
	{name = "Blue Camo Uzi", desc="Adesivo de arma..", weight=6, stack = false, weaponID = 28, AmmoID = 61, level=3, itemTypes= 'weapon'}, --124
	{name = "Desert Eagle - LEGALIZADA", desc="Não é VIP", weight=6, stack = false, weaponID = 24, AmmoID = 57, level=3, itemTypes= 'weapon'}, --125
	{name = "M16 Plublack", desc="Deixará de ser VIP no dia 03/04/2020..", weight=13, stack = false, weaponID = 31, AmmoID = 59, level=3, itemTypes= 'weapon'}, --126
	{name = "Artic Magnum", desc="Adesivo de arma..", weight=15, stack = false, weaponID = 34, AmmoID = 69, level=3, itemTypes= 'weapon'}, --127
	{name = "Shoutgun", desc=".", weight=10, stack = false, weaponID = 25, AmmoID = 60, level=3, itemTypes= 'weapon'}, --128
	{name = "Shoutgun Asiimov", desc="Diz a lenda que ninguem sobrevive a 1 tiro.", weight=10, stack = false, weaponID = 25, AmmoID = 60, level=3, itemTypes= 'weapon'}, --129
	{name = "Shotgun Viper", desc="Adesivo de arma..", weight=10, stack = false, weaponID = 25, AmmoID = 60, level=3, itemTypes= 'weapon'}, --130
	{name = "Tec-9 BOOM", desc="Adesivo de arma..", weight=6, stack = false, weaponID = 32, AmmoID = 61, level=3, itemTypes= 'weapon'}, --131
	{name = "Red Vein Tec-9", desc="Não consegue né? a melhor TEC 9", weight=6, stack = false, weaponID = 32, AmmoID = 61, level=3, itemTypes= 'weapon'}, --132
	{name = "AK-47 Asiimov", desc="Adesivo de arma..", weight=13, stack = false, weaponID = 30, AmmoID = 58, level=3, itemTypes= 'weapon'}, --133
	{name = "Spider faca", desc="Adesivo de arma..", weight=2, stack = false, weaponID = 4, AmmoID = false, level=2, itemTypes= 'weapon'}, --134
	{name = "Camo faca", desc="Adesivo de arma..", weight=2, stack = false, weaponID = 4, AmmoID = false, level=2, itemTypes= 'weapon'}, --135
	...
	{name = "Vice Magnum", desc="Adesivo de arma..", weight=15, stack = false, weaponID = 34, AmmoID = 69, level=3, itemTypes= 'weapon'}, --222
	{name = "Aliança Magnum", desc="Adesivo de arma..", weight=15, stack = false, weaponID = 34, AmmoID = 69, level=3, itemTypes= 'weapon'}, --223
	{name = "Dragon Magnum", desc="Adesivo de arma..", weight=15, stack = false, weaponID = 34, AmmoID = 69, level=3, itemTypes= 'weapon'}, --224
	{name = "Hyper Beast Magnum", desc="Adesivo de arma..", weight=15, stack = false, weaponID = 34, AmmoID = 69, level=3, itemTypes= 'weapon'}, --225
	{name = "Asiimov Magnum", desc="Adesivo de arma..", weight=15, stack = false, weaponID = 34, AmmoID = 69, level=3, itemTypes= 'weapon'}, --226
	...
	{name = "AK-47 Camo", desc="Excelente AK, uma das melhores!", weight=13, stack = false, weaponID = 30, AmmoID = 58, level=3, itemTypes= 'weapon'}, --241
	{name = "AK-47 Urban Camo", desc="Deixará de ser VIP no dia 03/04/2020..", weight=13, stack = false, weaponID = 30, AmmoID = 58, level=3, itemTypes= 'weapon'}, --242
	{name = "Desert Eagle Camo", desc="Adesivo de arma..", weight=6, stack = false, weaponID = 24, AmmoID = 57, level=3, itemTypes= 'weapon'}, --243
	{name = "MP5 Camo", desc="Adesivo de arma..", weight=6, stack = false, weaponID = 29, AmmoID = 61, level=3, itemTypes= 'weapon'}, --244
	{name = "MP5 Gold", desc="Adesivo de arma..", weight=6, stack = false, weaponID = 29, AmmoID = 61, level=3, itemTypes= 'weapon'}, --245
	...
	{name = "M16 Maya", desc="Adesivo de arma..", weight=13, stack = false, weaponID = 31, AmmoID = 59, level=3, itemTypes= 'weapon'}, --248
	...
	{name = "Esmeralda Faca", desc="Adesivo de arma..", weight=3, stack = false, weaponID = 4, AmmoID = false, level=2, itemTypes= 'weapon'}, --265
	{name = "Rubint faca", desc="Nada melhor quem um golpe sorrateiro", weight=3, stack = false, weaponID = 4, AmmoID = false, level=2, itemTypes= 'weapon'}, --266
	{name = "diamante faca", desc="Adesivo de arma..", weight=3, stack = false, weaponID = 4, AmmoID = false, level=2, itemTypes= 'weapon'}, --267
	...
	{name = "Aliança de Casamento Bruna & Noel", desc="Um casamento feliz exige que nos apaixonemos muitas vezes e sempre pela mesma pessoa.", weight=0.1, stack = true, weaponID = false, AmmoID = false, level=0, itemTypes= 'bag'}, --278
	...
	{name = "Desert Eagle Halloween", desc="Halloweeni Adesivo de arma..", weight=6, stack = false, weaponID = 24, AmmoID = 57, level=3, itemTypes= 'weapon'}, --287
	...
	{name = "M4 - Halloween", desc="Halloweeni Adesivo de arma..", weight=13, stack = false, weaponID = 31, AmmoID = 57, level=3, itemTypes= 'weapon'}, --298
	{name = "AK-47 - Halloween", desc="Halloweeni Adesivo de arma..", weight=13, stack = false, weaponID = 30, AmmoID = 57, level=3, itemTypes= 'weapon'}, --299
	{name = "Sniper - Halloween", desc="Halloweeni Adesivo de arma..", weight=15, stack = false, weaponID = 34, AmmoID = 57, level=3, itemTypes= 'weapon'}, --300
	{name = "Halloween", desc="Mascara para camuflar", weight=5, stack = false, weaponID = 34, AmmoID = 69, level=3, itemTypes= 'weapon'}, --301
	{name = "Gorro Natal", desc="Mascara para camuflar", weight=5, stack = false, weaponID = 34, AmmoID = 69, level=3, itemTypes= 'weapon'}, --302
	
	{name = "M4 - Natalina", desc="EDIÇÃO NATAL 2019", weight=13, stack = false, weaponID = 31, AmmoID = 57, level=3, itemTypes= 'weapon'}, --303
	{name = "AK-47 - Natalina", desc="EDIÇÃO NATAL 2019", weight=13, stack = false, weaponID = 30, AmmoID = 57, level=3, itemTypes= 'weapon'}, --304
	{name = "Sniper - Natalina", desc="EDIÇÃO NATAL 2019", weight=15, stack = false, weaponID = 34, AmmoID = 57, level=3, itemTypes= 'weapon'}, --305
	{name = "Desert - Natalina", desc="EDIÇÃO NATAL 2019", weight=6, stack = false, weaponID = 24, AmmoID = 57, level=3, itemTypes= 'weapon'}, --306


	{name = "M4A1 - PATRIOTA", desc="EDIÇÃO PATRIOTA", weight=13, stack = false, weaponID = 31, AmmoID = 57, level=3, itemTypes= 'weapon'}, --307
	{name = "AK-47 - PATRIOTA", desc="EDIÇÃO PATRIOTA", weight=13, stack = false, weaponID = 30, AmmoID = 57, level=3, itemTypes= 'weapon'}, --308
	{name = "AWM - PATRIOTA", desc="EDIÇÃO PATRIOTA", weight=15, stack = false, weaponID = 34, AmmoID = 57, level=3, itemTypes= 'weapon'}, --309


	{name = "DESERT - PATRIOTA", desc="EDIÇÃO PATRIOTA", weight=6, stack = false, weaponID = 24, AmmoID = 57, level=3, itemTypes= 'weapon'}, --310
	{name = "FACA - PATRIOTA", desc="EDIÇÃO PATRIOTA", weight=3, stack = false, weaponID = 4, AmmoID = false, level=2, itemTypes= 'weapon'}, --311
	{name = "TEC-9 - PATRIOTA", desc="EDIÇÃO PATRIOTA", weight=6, stack = false, weaponID = 32, AmmoID = 61, level=3, itemTypes= 'weapon'}, --312
	{name = "SHOUTGUN - PATRIOTA", desc="EDIÇÃO PATRIOTA", weight=10, stack = false, weaponID = 25, AmmoID = 60, level=3, itemTypes= 'weapon'}, --313
	{name = "MP5 - PATRIOTA", desc="EDIÇÃO PATRIOTA", weight=6, stack = false, weaponID = 29, AmmoID = 61, level=3, itemTypes= 'weapon'}, --314
	{name = "UZI - PATRIOTA", desc="EDIÇÃO PATRIOTA", weight=6, stack = false, weaponID = 28, AmmoID = 61, level=3, itemTypes= 'weapon'}, --315
	...
	{name = "M4A1 - FOLIA", desc="Edição Carnaval", weight=13, stack = false, weaponID = 31, AmmoID = 57, level=3, itemTypes= 'weapon'}, --318
	{name = "AK-47 - FOLIA", desc="Edição Carnaval", weight=13, stack = false, weaponID = 30, AmmoID = 57, level=3, itemTypes= 'weapon'}, --319
	{name = "AWM - FOLIA", desc="Edição Carnaval", weight=15, stack = false, weaponID = 34, AmmoID = 57, level=3, itemTypes= 'weapon'}, --320
	{name = "DESERT - FOLIA", desc="Edição Carnaval", weight=6, stack = false, weaponID = 24, AmmoID = 57, level=3, itemTypes= 'weapon'}, --321
	{name = "AK-47 - FLAMENGO", desc="Muito barulhento!", weight=13, stack = false, weaponID = 30, AmmoID = 57, level=3, itemTypes= 'weapon'}, --322
	
	
	 
	{name = "M4A1 - DOURADA", desc="EDIÇÃO DOURADA", weight=13, stack = false, weaponID = 31, AmmoID = 57, level=3, itemTypes= 'weapon'}, --323
	{name = "AK-47 - DOURADA", desc="EDIÇÃO DOURADA", weight=13, stack = false, weaponID = 30, AmmoID = 57, level=3, itemTypes= 'weapon'}, --324
	{name = "AWM - DOURADA", desc="EDIÇÃO DOURADA", weight=15, stack = false, weaponID = 34, AmmoID = 57, level=3, itemTypes= 'weapon'}, --325
	{name = "DESERT - DOURADA", desc="EDIÇÃO DOURADA", weight=6, stack = false, weaponID = 24, AmmoID = 57, level=3, itemTypes= 'weapon'}, --326
	{name = "TEC-9 - DOURADA", desc="EDIÇÃO DOURADA", weight=6, stack = false, weaponID = 32, AmmoID = 61, level=3, itemTypes= 'weapon'}, --327
	{name = "SHOUTGUN - DOURADA", desc="EDIÇÃO DOURADA", weight=10, stack = false, weaponID = 25, AmmoID = 60, level=3, itemTypes= 'weapon'}, --328
	{name = "MP5 - DOURADA", desc="EDIÇÃO DOURADA", weight=6, stack = false, weaponID = 29, AmmoID = 61, level=3, itemTypes= 'weapon'}, --329
	{name = "UZI - DOURADA", desc="EDIÇÃO DOURADA", weight=6, stack = false, weaponID = 28, AmmoID = 61, level=3, itemTypes= 'weapon'}, --330

	{name = "Baseball - GROVE", desc="Uma ferramenta popular para esportes de beisebol.", weight=3, stack = false, weaponID = 5, AmmoID = false, level=2, itemTypes= 'weapon'}, --331
	{name = "Baseball - DRAGON", desc="Uma ferramenta popular para esportes de beisebol.", weight=3, stack = false, weaponID = 5, AmmoID = false, level=2, itemTypes= 'weapon'}, --332

	{name = "FACA - DOURADA", desc="EDIÇÃO DOURADA", weight=3, stack = false, weaponID = 4, AmmoID = false, level=2, itemTypes= 'weapon'}, --333

	{name = "M4A1 - SAKURA", desc="Homenagem ao CrossFire", weight=13, stack = false, weaponID = 31, AmmoID = 57, level=3, itemTypes= 'weapon'}, --334


	{name = "M4A1 - CAVEIRA", desc="NEM TENTE A SORTE!", weight=13, stack = false, weaponID = 31, AmmoID = 57, level=3, itemTypes= 'weapon'}, --335
	{name = "AK-47 - RED DRAGON", desc="Homenagem ao CrossFire", weight=13, stack = false, weaponID = 30, AmmoID = 57, level=3, itemTypes= 'weapon'}, --336
	{name = "AWM - ALPHA", desc="Edição ALPHA", weight=15, stack = false, weaponID = 34, AmmoID = 57, level=3, itemTypes= 'weapon'}, --337
	{name = "DESERT - RED DRAGON", desc="Homenagem ao CrossFire", weight=6, stack = false, weaponID = 24, AmmoID = 57, level=3, itemTypes= 'weapon'}, --338
	{name = "M4A1 - RED DRAGON", desc="Homenagem ao CrossFire", weight=13, stack = false, weaponID = 31, AmmoID = 57, level=3, itemTypes= 'weapon'}, --339
	{name = "AWM - RED DRAGON", desc="Homenagem ao CrossFire", weight=15, stack = false, weaponID = 34, AmmoID = 57, level=3, itemTypes= 'weapon'}, --340
	

	{name = "Coelhinho", desc="Mascara para camuflar", weight=5, stack = false, weaponID = false, AmmoID = false, level=3, itemTypes= 'weapon'}, --341

 	{name = "M4A1 - ASIIMOV", desc="ASIIMOV TOP", weight=13, stack = false, weaponID = 31, AmmoID = 57, level=3, itemTypes= 'weapon'}, --342
	{name = "DESERT - ASIIMOV", desc="ASIIMOV TOP", weight=6, stack = false, weaponID = 24, AmmoID = 57, level=3, itemTypes= 'weapon'}, --343
...
specialItems = {
	...
	[341] = function(item,value,count)
		name = getItemName(item)
		desc = getItemDescription(item)
		return "#7cc576"..name .. "#FFFFFF\n" .. desc,"#FFA700(peso: "..getItemWeight(item).."kg)\n#FFA700(valor/ID: ".. value ..")"
	end,
	[342] = function(item,value,count)
		name = getItemName(item)
		desc = getItemDescription(item)
		return "#7cc576"..name .. "#FFFFFF\n" .. desc,"#FFA700(peso: "..getItemWeight(item).."kg)\n#FFA700(valor/ID: ".. value ..")"
	end,

	[343] = function(item,value,count)
		name = getItemName(item)
		desc = getItemDescription(item)
		return "#7cc576"..name .. "#FFFFFF\n" .. desc,"#FFA700(peso: "..getItemWeight(item).."kg)\n#FFA700(valor/ID: ".. value ..")"
	end,	
