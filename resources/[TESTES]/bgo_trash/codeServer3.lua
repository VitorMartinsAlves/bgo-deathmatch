kukaterulet3 = createColSphere(1922.3515625, 161.197265625, 37.212997436523,25)	
...
addEventHandler ( "onColShapeHit", kukaterulet3, hill_Enter )
	...
	local hours = time.hour
     ...
     return
		...
		if not isPedInVehicle(player) then 
			if isElementWithinColShape(player,kukaterulet3) then
...
--exports.bgo_chat:sendLocalMeAction(player," Encontrei um item: ".. exports["bgo_items"]:getItemName(randoms[randomcucc][1]))
					...
					elseif randoms[randomcucc][2] == "hp" then
						...
						outputChatBox("#c0c0c0[Lixão]:#FFFFFF Você furou a mão em algo enferrujado e perdeu #D75656-".. randoms[randomcucc][1] .." #ffffffde hp.",player,255,0,0,true)
